...
def fetch_historical_data(symbols, start_date, end_date, output_file):
    """
...
def main():
    ...
    logger.info("="*60)
    logger.info("HISTORICAL DATA FETCHER FOR BACKTESTING")
    logger.info("="*60)
    ...
    stock_data, failed = fetch_historical_data(
        STOCK_UNIVERSE, 
        start_str, 
        end_str, 
        stock_file
