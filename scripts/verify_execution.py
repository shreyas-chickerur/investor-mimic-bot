...
def verify_database_schema():
    ...
    print("✅ PASS: trades table has execution cost columns")
    ...
    print("✅ PASS: signals table has terminal state tracking")
...
def verify_trades():
    ...
    for row in cursor.fetchall():
        ...
        print(
            f"  {action} {shares} {symbol} @ ${exec_price:.2f} (cost: ${total_cost:.2f}, notional: ${notional:.2f})"
        )
