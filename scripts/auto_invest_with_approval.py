...
async def run_investment_workflow_with_approval(
    ...
    email_sent = await approval_manager.send_approval_email(
        ...
        recipient_email=approval_email
    )
...
def main():
    ...
    parser.add_argument(
        ...
        type=float,
        default=1000.0,
        help="Minimum cash threshold (default: 1000)"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=10.0,
        help="Cash buffer percentage (default: 10)"
    )
    ...
    # Run workflow
    try:
        asyncio.run(run_investment_workflow_with_approval(
