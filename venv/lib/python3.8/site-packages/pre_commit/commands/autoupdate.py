...
from pre_commit.clientlib import LOCAL, META, InvalidManifestError, load_config, load_manifest
...
def autoupdate(
    ...
    config_repos = [
        repo for repo in load_config(config_file)["repos"] if repo["repo"] not in {LOCAL, META}
    ]
