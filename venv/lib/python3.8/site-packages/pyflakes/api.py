...
from pyflakes import __version__, checker
...
def _get_version():
    ...
    """
    return "%s Python %s on %s" % (__version__, platform.python_version(), platform.system())
...
def main(prog=None, args=None):
    ...
    parser = argparse.ArgumentParser(prog=prog, description="Check Python source files for errors")
    parser.add_argument("-V", "--version", action="version", version=_get_version())
    parser.add_argument(
        "path", nargs="*", help="Path(s) of Python file(s) to check. STDIN if not given."
    )
