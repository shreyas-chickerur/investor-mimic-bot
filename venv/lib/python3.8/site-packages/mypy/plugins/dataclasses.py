...
class DataclassTransformer:
    ...
    def transform(self) -> bool:
        ...
        if decorator_arguments["order"]:
            ...
            for method_name in ["__lt__", "__gt__", "__le__", "__ge__"]:
                ...
                order_args = [Argument(Var("other", order_tvar_def), order_tvar_def, None, ARG_POS)]
    ...
    def _add_dunder_replace(self, attributes: list[DataclassAttribute]) -> None:
        ...
        args = [
            attr.to_argument(self._cls.info, of="replace") for attr in attributes if attr.is_in_init
        ]
    ...
    def collect_attributes(self) -> list[DataclassAttribute] | None:
        ...
        for stmt in self._get_assignment_statements_from_block(cls.defs):
            ...
            found_attrs[lhs.name] = DataclassAttribute(
                ...
                info=cls.info,
                kw_only=is_kw_only,
                is_neither_frozen_nor_nonfrozen=_has_direct_dataclass_transform_metaclass(cls.info),
                api=self._api,
            )
