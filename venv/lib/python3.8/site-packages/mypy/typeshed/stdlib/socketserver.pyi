...
_AfInetAddress: TypeAlias = tuple[
    str | bytes | bytearray, int
]  # address acceptable for an AF_INET socket
...
class ThreadingMixIn:
    ...
    def process_request_thread(
        self, request: _RequestType, client_address: _RetAddress
    ) -> None: ...  # undocumented
    def process_request(self, request: _RequestType, client_address: _RetAddress) -> None: ...
    def server_close(self) -> None: ...
...
class BaseRequestHandler:
    ...
    server: BaseServer
    def __init__(
        self, request: _RequestType, client_address: _RetAddress, server: BaseServer
    ) -> None: ...
    def setup(self) -> None: ...
