...
class CompletedProcess(Generic[_T]):
    ...
    stderr: _T
    def __init__(
        self, args: _CMD, returncode: int, stdout: _T | None = None, stderr: _T | None = None
    ) -> None: ...
...
if sys.platform == "win32":
    ...
    from _winapi import ABOVE_NORMAL_PRIORITY_CLASS as ABOVE_NORMAL_PRIORITY_CLASS
    from _winapi import BELOW_NORMAL_PRIORITY_CLASS as BELOW_NORMAL_PRIORITY_CLASS
    from _winapi import CREATE_BREAKAWAY_FROM_JOB as CREATE_BREAKAWAY_FROM_JOB
    from _winapi import CREATE_DEFAULT_ERROR_MODE as CREATE_DEFAULT_ERROR_MODE
    from _winapi import CREATE_NEW_CONSOLE as CREATE_NEW_CONSOLE
    from _winapi import CREATE_NEW_PROCESS_GROUP as CREATE_NEW_PROCESS_GROUP
    from _winapi import CREATE_NO_WINDOW as CREATE_NO_WINDOW
    from _winapi import DETACHED_PROCESS as DETACHED_PROCESS
    from _winapi import HIGH_PRIORITY_CLASS as HIGH_PRIORITY_CLASS
    from _winapi import IDLE_PRIORITY_CLASS as IDLE_PRIORITY_CLASS
    from _winapi import NORMAL_PRIORITY_CLASS as NORMAL_PRIORITY_CLASS
    from _winapi import REALTIME_PRIORITY_CLASS as REALTIME_PRIORITY_CLASS
    from _winapi import STARTF_USESHOWWINDOW as STARTF_USESHOWWINDOW
    from _winapi import STARTF_USESTDHANDLES as STARTF_USESTDHANDLES
    from _winapi import STD_ERROR_HANDLE as STD_ERROR_HANDLE
    from _winapi import STD_INPUT_HANDLE as STD_INPUT_HANDLE
    from _winapi import STD_OUTPUT_HANDLE as STD_OUTPUT_HANDLE
    from _winapi import SW_HIDE as SW_HIDE
