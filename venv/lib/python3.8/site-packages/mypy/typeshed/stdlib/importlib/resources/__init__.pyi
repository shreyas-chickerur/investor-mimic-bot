...
if sys.version_info >= (3, 13):
    ...
    from importlib.resources._functional import contents as contents
    from importlib.resources._functional import is_resource as is_resource
    from importlib.resources._functional import open_binary as open_binary
    from importlib.resources._functional import open_text as open_text
    from importlib.resources._functional import path as path
    from importlib.resources._functional import read_binary as read_binary
    from importlib.resources._functional import read_text as read_text
