...
def charmap_decode(
    data: ReadableBuffer, errors: str | None = None, mapping: _CharMap | None = None, /
) -> tuple[str, int]: ...
def charmap_encode(
    str: str, errors: str | None = None, mapping: _CharMap | None = None, /
) -> tuple[bytes, int]: ...
...
if sys.version_info >= (3, 9):
    ...
    def raw_unicode_escape_decode(
        data: str | ReadableBuffer, errors: str | None = None, /
    ) -> tuple[str, int]: ...
...
def utf_16_be_decode(
    data: ReadableBuffer, errors: str | None = None, final: bool = False, /
) -> tuple[str, int]: ...
...
def utf_16_encode(
    str: str, errors: str | None = None, byteorder: int = 0, /
) -> tuple[bytes, int]: ...
...
if sys.platform == "win32":
    ...
    def code_page_encode(
        code_page: int, str: str, errors: str | None = None, /
    ) -> tuple[bytes, int]: ...
    def oem_decode(
        data: ReadableBuffer, errors: str | None = None, final: bool = False, /
    ) -> tuple[str, int]: ...
