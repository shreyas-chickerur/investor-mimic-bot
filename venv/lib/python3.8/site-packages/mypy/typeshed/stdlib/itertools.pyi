...
class accumulate(Iterator[_T]):
    ...
    @overload
    def __init__(
        self, iterable: Iterable[_S], func: Callable[[_T, _S], _T], *, initial: _T | None = ...
    ) -> None: ...
    def __iter__(self) -> Self: ...
    def __next__(self) -> _T: ...
...
class islice(Iterator[_T]):
    ...
    @overload
    def __init__(
        self, iterable: Iterable[_T], start: int | None, stop: int | None, step: int | None = ..., /
    ) -> None: ...
    def __iter__(self) -> Self: ...
    def __next__(self) -> _T: ...
...
class zip_longest(Iterator[_T_co]):
    ...
    ) -> zip_longest[tuple[_T1 | MaybeNone, _T2 | MaybeNone]]: ...
    @overload
    def __new__(
    ...
    def __new__(
        ...
        tuple[_T1 | MaybeNone, _T2 | MaybeNone, _T3 | MaybeNone, _T4 | MaybeNone, _T5 | MaybeNone]
    ]: ...
    @overload
    def __new__(
        cls,
