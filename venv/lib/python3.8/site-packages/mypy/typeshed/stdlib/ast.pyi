import os
import sys
from _ast import PyCF_ALLOW_TOP_LEVEL_AWAIT as PyCF_ALLOW_TOP_LEVEL_AWAIT
from _ast import PyCF_ONLY_AST as PyCF_ONLY_AST
from _ast import PyCF_TYPE_COMMENTS as PyCF_TYPE_COMMENTS
...
class Raise(stmt):
    ...
    cause: expr | None
    def __init__(
        self, exc: expr | None = None, cause: expr | None = None, **kwargs: Unpack[_Attributes]
    ) -> None: ...
...
class Constant(expr):
    ...
    if sys.version_info >= (3, 14):
        def __replace__(
            self, *, value: Any = ..., kind: str | None = ..., **kwargs: Unpack[_Attributes]
        ) -> Self: ...
...
class keyword(AST):
    ...
    @overload
    def __init__(
        self, arg: _Identifier | None = None, *, value: expr, **kwargs: Unpack[_Attributes]
    ) -> None: ...
...
class alias(AST):
    ...
    def __init__(
        self, name: str, asname: _Identifier | None = None, **kwargs: Unpack[_Attributes]
    ) -> None: ...
