...
class ScrolledCanvas(Canvas, Frame):  # type: ignore[misc]
    ...
    canvheight: int
    def reset(
        self, canvwidth: int | None = None, canvheight: int | None = None, bg: str | None = None
    ) -> None: ...
...
class TurtleScreen(TurtleScreenBase):
    def __init__(
        self, cv: Canvas, mode: str = "standard", colormode: float = 1.0, delay: int = 10
    ) -> None: ...
    def clear(self) -> None: ...
    @overload
    ...
    def onclick(
        self, fun: Callable[[float, float], object], btn: int = 1, add: Any | None = None
    ) -> None: ...
...
class TNavigator:
    ...
    if sys.version_info >= (3, 12):
        def teleport(
            self, x: float | None = None, y: float | None = None, *, fill_gap: bool = False
        ) -> None: ...
...
class RawTurtle(TPen, TNavigator):  # type: ignore[misc]  # Conflicting methods in base classes
    ...
    getpen = getturtle
    def onclick(
        self, fun: Callable[[float, float], object], btn: int = 1, add: bool | None = None
    ) -> None: ...
    def onrelease(
        self, fun: Callable[[float, float], object], btn: int = 1, add: bool | None = None
    ) -> None: ...
...
def setup(
    width: float = 0.5, height: float = 0.75, startx: int | None = None, starty: int | None = None
) -> None: ...
