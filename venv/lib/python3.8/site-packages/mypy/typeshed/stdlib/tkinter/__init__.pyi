...
class Variable:
    def __init__(
        self, master: Misc | None = None, value: Incomplete | None = None, name: str | None = None
    ) -> None: ...
...
class StringVar(Variable):
    def __init__(
        self, master: Misc | None = None, value: str | None = None, name: str | None = None
    ) -> None: ...
...
class IntVar(Variable):
    def __init__(
        self, master: Misc | None = None, value: int | None = None, name: str | None = None
    ) -> None: ...
...
class DoubleVar(Variable):
    def __init__(
        self, master: Misc | None = None, value: float | None = None, name: str | None = None
    ) -> None: ...
...
class BooleanVar(Variable):
    def __init__(
        self, master: Misc | None = None, value: bool | None = None, name: str | None = None
    ) -> None: ...
...
class Misc:
    ...
    def after(
        self, ms: int | Literal["idle"], func: Callable[[Unpack[_Ts]], object], *args: Unpack[_Ts]
    ) -> str: ...
    ...
    @overload
    def bind(
        self, sequence: str | None, func: str, add: Literal["", "+"] | bool | None = None
    ) -> None: ...
    @overload
...
class Wm:
    ...
    def wm_iconphoto(
        self, default: bool, image1: _PhotoImageLike | str, /, *args: _PhotoImageLike | str
    ) -> None: ...
...
class Canvas(Widget, XView, YView):
    ...
    def addtag_enclosed(
        self, newtag: str, x1: _ScreenUnits, y1: _ScreenUnits, x2: _ScreenUnits, y2: _ScreenUnits
    ) -> None: ...
    ...
    @overload
    def tag_bind(
        self, tagOrId: str | int, *, func: str, add: Literal["", "+"] | bool | None = None
    ) -> None: ...
    ...
    def moveto(
        self, tagOrId: str | int, x: Literal[""] | float = "", y: Literal[""] | float = ""
    ) -> None: ...
...
class Menu(Widget):
    ...
    def insert_separator(
        self, index: str | int, cnf: dict[str, Any] | None = {}, *, background: str = ...
    ) -> None: ...
...
class Text(Widget, XView, YView):
    ...
    def compare(
        self, index1: _TextIndex, op: Literal["<", "<=", "==", ">=", ">", "!="], index2: _TextIndex
    ) -> bool: ...
    if sys.version_info >= (3, 13):
        ...
        @overload
        def count(
            self, index1: _TextIndex, index2: _TextIndex, *, return_ints: Literal[False] = False
        ) -> tuple[int] | None: ...
        @overload
        def count(
            self,
        ...
        @overload
        def count(
            self, index1: _TextIndex, index2: _TextIndex, arg1: _WhatToCount, arg2: _WhatToCount, /
        ) -> tuple[int, int]: ...
        @overload
        def count(
            self,
...
class PhotoImage(Image, _PhotoImageLike):
    ...
    if sys.version_info >= (3, 13):
        ...
        def subsample(
            self, x: int, y: Literal[""] = "", *, from_coords: Iterable[int] | None = None
        ) -> PhotoImage: ...
        def zoom(
            self, x: int, y: Literal[""] = "", *, from_coords: Iterable[int] | None = None
        ) -> PhotoImage: ...
