...
_ExitFunc: TypeAlias = Callable[
    [type[BaseException] | None, BaseException | None, TracebackType | None], bool | None
]
...
class _GeneratorContextManager(
    _GeneratorContextManagerBase, AbstractContextManager[_T_co, bool | None], ContextDecorator
):
    ...
    def __init__(
        self, func: Callable[..., Iterator[_T_co]], args: tuple[Any, ...], kwds: dict[str, Any]
    ) -> None: ...
...
if sys.version_info >= (3, 10):
    ...
    class _AsyncGeneratorContextManager(
        _GeneratorContextManagerBase, AbstractAsyncContextManager[_T_co, bool | None]
    ):
        def __init__(
            self,
            func: Callable[..., AsyncIterator[_T_co]],
