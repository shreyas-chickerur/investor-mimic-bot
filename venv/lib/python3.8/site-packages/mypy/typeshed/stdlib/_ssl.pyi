...
from ssl import SSLSyscallError as SSLSyscallError
from ssl import SSLWantReadError as SSLWantReadError
from ssl import SSLWantWriteError as SSLWantWriteError
from ssl import SSLZeroReturnError as SSLZeroReturnError
...
class _SSLContext:
    ...
    if sys.version_info >= (3, 13):
        def set_psk_client_callback(
            self, callback: Callable[[str | None], tuple[str | None, bytes]] | None
        ) -> None: ...
