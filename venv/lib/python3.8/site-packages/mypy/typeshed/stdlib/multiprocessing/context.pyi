...
class BaseContext:
    ...
    if sys.platform != "win32":
        ...
        ) -> tuple[Connection[Any, Any], Connection[Any, Any]]: ...
    else:
        def Pipe(
            self, duplex: bool = True
        ) -> tuple[PipeConnection[Any, Any], PipeConnection[Any, Any]]: ...
    ...
    @overload
    def Value(
        self, typecode_or_type: type[_CT], *args: Any, lock: Literal[True] | _LockLike = True
    ) -> Synchronized[_CT]: ...
    @overload
    def Value(
    ...
    @overload
    def Value(
        self, typecode_or_type: str | type[_CData], *args: Any, lock: bool | _LockLike = True
    ) -> Any: ...
    @overload
    def Array(
        self,
