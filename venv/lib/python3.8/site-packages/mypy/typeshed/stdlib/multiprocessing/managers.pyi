...
class BaseListProxy(BaseProxy, MutableSequence[_T]):
    ...
    @overload
    def sort(
        self: BaseListProxy[SupportsRichComparisonT], *, key: None = None, reverse: bool = ...
    ) -> None: ...
    @overload
...
class Server:
    ...
    def accept_connection(
        self,
        c: Connection[
            tuple[str, str | None], tuple[str, str, Iterable[Incomplete], Mapping[str, Incomplete]]
        ],
        name: str,
    ) -> None: ...
...
class BaseManager:
    ...
    def start(
        self, initializer: Callable[..., object] | None = None, initargs: Iterable[Any] = ()
    ) -> None: ...
