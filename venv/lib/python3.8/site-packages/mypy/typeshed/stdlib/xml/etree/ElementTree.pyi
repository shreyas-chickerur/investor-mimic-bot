...
class Element:
    ...
    @overload
    def findtext(
        self, path: str, default: _T, namespaces: dict[str, str] | None = None
    ) -> _T | str: ...
    @overload
...
def SubElement(
    parent: Element, tag: str, attrib: dict[str, str] = ..., **extra: str
) -> Element: ...
...
class XMLPullParser:
    def __init__(
        self, events: Sequence[str] | None = None, *, _parser: XMLParser | None = None
    ) -> None: ...
...
def XMLID(
    text: str | ReadableBuffer, parser: XMLParser | None = None
...
def fromstringlist(
    sequence: Sequence[str | ReadableBuffer], parser: XMLParser | None = None
) -> Element: ...
