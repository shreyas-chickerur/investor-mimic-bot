...
class StatisticDiff:
    ...
    traceback: Traceback
    def __init__(
        self, traceback: Traceback, size: int, size_diff: int, count: int, count_diff: int
    ) -> None: ...
    def __eq__(self, other: object) -> bool: ...
    def __hash__(self) -> int: ...
...
if sys.version_info >= (3, 9):
    _TraceTuple: TypeAlias = (
        tuple[int, int, Sequence[_FrameTuple], int | None] | tuple[int, int, Sequence[_FrameTuple]]
    )
else:
