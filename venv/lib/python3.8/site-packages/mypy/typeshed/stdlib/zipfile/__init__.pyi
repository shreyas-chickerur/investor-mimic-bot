...
class ZipFile:
    ...
    def extract(
        self, member: str | ZipInfo, path: StrPath | None = None, pwd: bytes | None = None
    ) -> str: ...
    def extractall(
        self,
...
class PyZipFile(ZipFile):
    ...
    def writepy(
        self, pathname: str, basename: str = "", filterfunc: Callable[[str], bool] | None = None
    ) -> None: ...
...
if sys.version_info >= (3, 12):
    ...
    from zipfile._path import Path as Path
