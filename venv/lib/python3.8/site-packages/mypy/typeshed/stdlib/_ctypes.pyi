...
# on _CData itself.
_CDataType: TypeAlias = (
    _SimpleCData[Any] | _Pointer[Any] | CFuncPtr | Union | Structure | Array[Any]
)
...
class _PyCSimpleType(_CTypeBaseType):
    ...
    def from_buffer(
        self: type[_typeshed.Self], obj: WriteableBuffer, offset: int = 0, /
    ) -> _typeshed.Self: ...
    def from_buffer_copy(
        self: type[_typeshed.Self], buffer: ReadableBuffer, offset: int = 0, /
    ) -> _typeshed.Self: ...
...
_ECT: TypeAlias = Callable[
    [_CData | _CDataType | None, CFuncPtr, tuple[_CData | _CDataType, ...]], _CDataType
]
...
class CFuncPtr(_PointerLike, _CData, metaclass=_PyCFuncPtrType):
    ...
    @overload
    def __init__(
        self, func_spec: tuple[str | int, CDLL], paramflags: tuple[_PF, ...] | None = ..., /
    ) -> None: ...
    if sys.platform == "win32":
        @overload
        def __init__(
...
def buffer_info(
    o: _CData | _CDataType | type[_CData | _CDataType], /
