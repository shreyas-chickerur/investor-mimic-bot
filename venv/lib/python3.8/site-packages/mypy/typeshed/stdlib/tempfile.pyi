...
class _TemporaryFileWrapper(IO[AnyStr]):
    ...
    if sys.version_info >= (3, 12):
        def __init__(
            self, file: IO[AnyStr], name: str, delete: bool = True, delete_on_close: bool = True
        ) -> None: ...
    else:
...
class SpooledTemporaryFile(IO[AnyStr], _SpooledTemporaryFileBase):
    ...
    @overload
    def writelines(
        self: SpooledTemporaryFile[bytes], iterable: Iterable[ReadableBuffer]
    ) -> None: ...
    @overload
...
@overload
def mkdtemp(
    suffix: str | None = None, prefix: str | None = None, dir: StrPath | None = None
) -> str: ...
@overload
def mkdtemp(
    suffix: bytes | None = None, prefix: bytes | None = None, dir: BytesPath | None = None
) -> bytes: ...
