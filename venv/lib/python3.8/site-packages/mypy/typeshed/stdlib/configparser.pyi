...
class RawConfigParser(_Parser):
    ...
    def read(
        self, filenames: StrOrBytesPath | Iterable[StrOrBytesPath], encoding: str | None = None
    ) -> list[str]: ...
    ...
    @overload
    def getint(
        self, section: str, option: str, *, raw: bool = False, vars: _Section | None = None
    ) -> int: ...
    @overload
    def getint(
        self,
...
class DuplicateOptionError(Error):
    ...
    lineno: int | None
    def __init__(
        self, section: str, option: str, source: str | None = None, lineno: int | None = None
    ) -> None: ...
