    ...
    def with_normalized_var_args(self) -> Self:
        ...
        if unpack_index is None:
            ...
            if unpack_index == len(unpacked.items) - 1:
                ...
                new_unpack = UnpackType(unpacked.copy_modified(items=unpacked.items[unpack_index:]))
...
from mypy.type_visitor import ALL_STRATEGY as ALL_STRATEGY
from mypy.type_visitor import ANY_STRATEGY as ANY_STRATEGY
from mypy.type_visitor import BoolTypeQuery as BoolTypeQuery
from mypy.type_visitor import SyntheticTypeVisitor as SyntheticTypeVisitor
...
class UnrollAliasVisitor(TrivialSyntheticTypeTranslator):
    def __init__(self, initial_aliases: set[TypeAliasType], cache: dict[Type, Type] | None) -> None:
