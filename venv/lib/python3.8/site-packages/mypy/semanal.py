...
from mypy.semanal_shared import set_callable_name as set_callable_name
...
class SemanticAnalyzer(
    ...
    def check_type_alias_bases(self, bases: list[Expression]) -> None:
        for base in bases:
            ...
            if (
                ...
                self.fail('Type alias defined using "type" statement not valid as base class', base)
    ...
    def analyze_namedtuple_assign(self, s: AssignmentStmt) -> bool:
        ...
        if isinstance(s.rvalue, CallExpr) and isinstance(s.rvalue.analyzed, NamedTupleExpr):
            if s.rvalue.analyzed.info.tuple_type and not has_placeholder(
                ...
                return (
                    True  # This is a valid and analyzed named tuple definition, nothing to do here.
                )
    ...
    def analyze_type_alias_type_params(self, rvalue: CallExpr) -> tuple[TypeVarLikeList, list[str]]:
        ...
        if refers_to_fullname(expr.callee, "typing.cast"):
            ...
            if (
                ...
                if expr.callee.name == "append" and expr.args:
                    ...
                    expr.callee.name == "remove" and expr.args and isinstance(expr.args[0], StrExpr)
                ):
