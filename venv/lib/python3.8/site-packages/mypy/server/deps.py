...
from mypy.operators import op_methods, ops_with_inplace_method, reverse_op_methods, unary_op_methods
...
class DependencyVisitor(TraverserVisitor):
    ...
    def visit_assignment_stmt(self, o: AssignmentStmt) -> None:
        ...
        if isinstance(rvalue, CallExpr) and isinstance(rvalue.analyzed, TypeVarExpr):
            ...
            self.add_type_dependencies(analyzed.upper_bound, target=make_trigger(analyzed.fullname))
