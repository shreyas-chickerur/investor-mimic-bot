...
from setuptools.extern.six.moves import configparser, http_client, map, urllib
...
class PackageIndex(Environment):
    ...
    def __init__(
        ...
        **kw
        ...
        self.to_scan = []
        use_ssl = (
            verify_ssl and ssl_support.is_available and (ca_bundle or ssl_support.find_ca_bundle())
        )
        if use_ssl:
