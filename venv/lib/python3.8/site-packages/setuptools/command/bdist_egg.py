...
from pkg_resources import Distribution, EntryPoint, ensure_directory, get_build_platform
    ...
    def gen_header(self):
        ...
        if not ep.attrs or ep.extras:
            raise DistutilsSetupError(
                "eggsecutable entry point (%r) cannot have 'extras' " "or refer to a module" % (ep,)
            )
