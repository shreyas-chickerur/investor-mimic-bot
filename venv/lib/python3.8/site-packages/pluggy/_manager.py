...
import types
import warnings
from typing import TYPE_CHECKING, Any, Callable, Final, Iterable, Mapping, Sequence, cast
...
class PluginManager:
    ...
    def _verify_hook(self, hook: HookCaller, hookimpl: HookImpl) -> None:
        ...
        if (hookimpl.wrapper or hookimpl.hookwrapper) and not inspect.isgeneratorfunction(
            hookimpl.function
        ):
            raise PluginValidationError(
                hookimpl.plugin,
