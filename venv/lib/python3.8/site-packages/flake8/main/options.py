...
def register_default_options(option_manager: OptionManager) -> None:
    ...
    add_option(
        ...
        help="Comma-separated list of files or directories to exclude. " "(Default: %(default)s)",
    )
    ...
    add_option(
        ...
        comma_separated_list=True,
        normalize_paths=True,
        help="Comma-separated list of files or directories to add to the list " "of excluded ones.",
    )
    ...
    add_option(
        ...
        parse_from_config=True,
        help="Maximum allowed line length for the entirety of this run. " "(Default: %(default)s)",
    )
