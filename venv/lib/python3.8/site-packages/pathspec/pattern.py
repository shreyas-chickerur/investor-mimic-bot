...
from typing import (
    Match as MatchHint,  # Replaced by `X | Y` in 3.10.; Replaced by `re.Match` in 3.9.
)
from typing import Pattern as PatternHint  # Replaced by `re.Pattern` in 3.9.
    ...
    def match_file(self, file: str) -> Optional[Any]:
        ...
        *file* (:class:`str`) is the normalized file path to match against.
        ...
        raise NotImplementedError(
            ("{cls.__module__}.{cls.__qualname__} must override match_file().").format(
                cls=self.__class__
            )
        )
