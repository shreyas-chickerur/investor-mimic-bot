...
from typing import Callable  # Replaced by `collections.abc.Callable` in 3.9.
from typing import Collection  # Replaced by `collections.abc.Collection` in 3.9.
from typing import Dict  # Replaced by `dict` in 3.9.
from typing import Iterable  # Replaced by `collections.abc.Iterable` in 3.9.
from typing import Iterator  # Replaced by `collections.abc.Iterator` in 3.9.
from typing import List  # Replaced by `list` in 3.9.
from typing import Optional  # Replaced by `X | None` in 3.10.
from typing import Sequence  # Replaced by `collections.abc.Sequence` in 3.9.
from typing import Set  # Replaced by `set` in 3.9.
from typing import Tuple  # Replaced by `tuple` in 3.9.
from typing import Any, AnyStr, Generic, TypeVar, Union  # Replaced by `X | Y` in 3.10.
...
NORMALIZE_PATH_SEPS = [__sep for __sep in [os.sep, os.altsep] if __sep and __sep != posixpath.sep]
"""
