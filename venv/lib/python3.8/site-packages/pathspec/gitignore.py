...
from typing import Union  # Replaced by `X | Y` in 3.10.
from typing import AnyStr, TypeVar, cast, overload

from .pathspec import PathSpec
from .pattern import Pattern
from .patterns.gitwildmatch import _DIR_MARK, GitWildMatchPattern
