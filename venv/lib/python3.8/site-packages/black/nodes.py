...
import sys
from typing import Final, Generic, Iterator, List, Literal, Optional, Set, Tuple, TypeVar, Union
...
def is_docstring(node: NL, mode: Mode) -> bool:
    ...
    if prev_siblings_are(node.parent, [None, token.NEWLINE, token.INDENT, syms.simple_stmt]):
        return True
...
def is_with_or_async_with_stmt(leaf: Leaf) -> bool:
    ...
    return bool(
        ...
        leaf.type == token.ASYNC and leaf.next_sibling and leaf.next_sibling.type == syms.with_stmt
    )
