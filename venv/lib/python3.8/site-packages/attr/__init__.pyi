import enum
import sys
from typing import Any, Callable, Generic, Literal, Mapping, Protocol, Sequence, TypeVar, overload
...
from attrs import mutable as mutable
...
def attrib(
    ...
    metadata: Mapping[Any, Any] | None = ...,
    type: type[_T] | None = ...,
    converter: _ConverterType | list[_ConverterType] | tuple[_ConverterType] | None = ...,
