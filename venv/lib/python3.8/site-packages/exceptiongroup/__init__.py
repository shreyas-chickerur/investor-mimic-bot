...
if sys.version_info < (3, 11):
    ...
    from ._formatting import format_exception, format_exception_only, print_exc, print_exception
    ...
    from traceback import format_exception, format_exception_only, print_exc, print_exception
