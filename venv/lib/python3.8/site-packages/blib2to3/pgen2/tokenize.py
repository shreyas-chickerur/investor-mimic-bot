...
import builtins
import sys
from typing import Callable, Final, Iterable, Iterator, List, Optional, Pattern, Set, Tuple, Union
        ...
        while pos < max:
            ...
            if pseudomatch:  # scan for tokens
                ...
                if initial in numchars or (initial == "." and token != "."):  # ordinary number
                    ...
                    maybe_endprog = (
                        endprogs.get(initial) or endprogs.get(token[:2]) or endprogs.get(token[:3])
                    )
