...
class PortfolioRiskManager:
    ...
    def __init__(self, 
        ...
        Args:
            max_portfolio_heat: Maximum percentage of capital exposed
            max_daily_loss_pct: Maximum daily loss before halting trading
        ...
        logger.info(f"Portfolio Risk Manager: max_heat={max_portfolio_heat*100}%, "
