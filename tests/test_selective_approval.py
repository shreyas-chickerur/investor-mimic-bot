...
import pytest
from services.approval.trade_approval import TradeApprovalManager, ApprovalStatus
...
def run_manual_tests():
    ...
    sample_trades = [
        {"symbol": "GOOGL", "quantity": 15.2, "estimated_price": 296.72, "estimated_value": 4510.14, "allocation_pct": 7.8},
        {"symbol": "UBER", "quantity": 45.3, "estimated_price": 128.50, "estimated_value": 5821.05, "allocation_pct": 6.5},
        {"symbol": "AAPL", "quantity": 25.0, "estimated_price": 185.50, "estimated_value": 4637.50, "allocation_pct": 5.2},
        {"symbol": "MSFT", "quantity": 12.5, "estimated_price": 378.90, "estimated_value": 4736.25, "allocation_pct": 5.0},
        {"symbol": "AMZN", "quantity": 8.5, "estimated_price": 178.20, "estimated_value": 1514.70, "allocation_pct": 1.7}
    ]
    ...
    for trade in approved_trades:
        print(f"  - {trade.symbol}: {trade.quantity} shares @ ${trade.estimated_price:.2f} = ${trade.estimated_value:,.2f}")
    total_value = sum(t.estimated_value for t in approved_trades)
