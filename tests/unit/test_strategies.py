...
class TestRSIMeanReversionStrategy:
    ...
    def test_strategy_initialization(self):
        ...
        assert strategy.rsi_threshold == 38  # entry threshold widened 35 → 38 for more signals
    ...
    def test_rsi_handles_missing_data(self):
        ...
        data = pd.DataFrame(
            {"symbol": ["AAPL"] * 10, "close": [150] * 10, "volume": [1000000] * 10}
        )
    ...
    def test_rsi_requires_minimum_data(self):
        ...
        data = pd.DataFrame({"symbol": ["AAPL"], "close": [150], "rsi": [28], "volume": [1000000]})
