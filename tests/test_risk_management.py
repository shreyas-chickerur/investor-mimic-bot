...
class TestPortfolioRiskManager:
    ...
    def test_daily_loss_limit_triggers_halt(self):
        ...
        assert risk_manager.trading_halted == True
...
class TestCorrelationFilter:
    ...
    def test_correlation_filter_rejects_high_correlation(self):
        ...
        should_filter, reason, correlations = corr_filter.should_filter_signal('MSFT', existing_positions)
...
class TestStopLossManager:
    ...
    def test_catastrophe_stop_loss_trigger(self):
        ...
        # Check if triggered at 3x ATR below entry
        current_price = 135  # Down 15 points = 3x ATR
    ...
    def test_catastrophe_stop_loss_no_trigger(self):
        ...
        # Check at 2x ATR (within 2.5x threshold)
        current_price = 140  # Down 10 points = 2x ATR (within threshold)
...
class TestDrawdownStopManager:
    ...
    def test_drawdown_halt_threshold(self):
        ...
        dd_manager = DrawdownStopManager(
            db=mock_db,
    ...
    def test_drawdown_cooldown_period(self):
        ...
        assert dd_manager.is_trading_allowed() == False
...
class TestRiskManagerIntegration:
    ...
    def test_risk_checks_execute_in_order(self):
        ...
        assert result == False  # Halted due to daily loss
