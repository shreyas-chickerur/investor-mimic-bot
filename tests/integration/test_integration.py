...
from utils.validators import ValidationError, trade_validator
...
class TestDataQualityIntegration:
    ...
    def test_price_validation(self):
        ...
        data = {"prices": {"AAPL": 150.0, "MSFT": 300.0}, "timestamp": datetime.now()}
    ...
    def test_invalid_price_detection(self):
        ...
        data = {"prices": {"AAPL": -150.0}, "timestamp": datetime.now()}  # Invalid negative price
...
class TestEndToEndWorkflow:
    ...
    def test_trade_workflow(self):
        ...
        checker = get_quality_checker()
        data = {"prices": {"AAPL": 150.0}, "timestamp": datetime.now()}
        ...
        success = engine.place_order(
            validated["ticker"], validated["action"], validated["quantity"], validated["price"]
        )
        assert success is True
