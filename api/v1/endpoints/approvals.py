...
async def approve_request(request_id: str, notes: Optional[str] = None) -> ApprovalResponse:
    """
...
async def reject_request(request_id: str, notes: Optional[str] = None) -> ApprovalResponse:
    """
    ...
    Returns:
        ApprovalResponse with success status
    """
    success = approval_manager.reject_request(request_id=request_id, notes=notes)
    ...
    return ApprovalResponse(success=True, message="Trade request rejected", request=request)


@router.api_route("/{request_id}/approve-trade/{trade_index}", methods=["GET", "POST"])
async def approve_trade(request_id: str, trade_index: int) -> ApprovalResponse:
    """
    ...
    Returns:
        ApprovalResponse with success status
    """
    success = approval_manager.approve_trade(request_id=request_id, trade_index=trade_index)
...
async def reject_trade(request_id: str, trade_index: int) -> ApprovalResponse:
    """
    ...
    Returns:
        ApprovalResponse with success status
    """
    success = approval_manager.reject_trade(request_id=request_id, trade_index=trade_index)
...
async def submit_bulk_approval(request_id: str, decisions: Dict[str, str]) -> ApprovalResponse:
    """
