...
from services.strategy.sell_signals import SellSignalGenerator, Position
...
class CompleteSignalWeights:
    ...
    def __post_init__(self):
        ...
        total = (self.conviction_13f + self.news_sentiment + 
                self.insider_trading + self.technical)
...
class CompleteSignalEngine:
    ...
    def __init__(
        ...
        self.sell_signal_generator = SellSignalGenerator(
            stop_loss_pct=-10.0,
    ...
    def compute_all_signals(
        ...
        if use_insider:
            ...
            insider_signals = self.insider_generator.get_mock_signals(
                symbols,
                conviction_signals
            )
    ...
    def get_recommendations(
        ...
        for symbol, final_score in sorted_scores:
            ...
            recommendations.append(CompleteAnalysis(
                symbol=symbol,
