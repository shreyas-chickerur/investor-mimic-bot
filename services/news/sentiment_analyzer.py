...
class SimpleSentimentAnalyzer:
    ...
    POSITIVE_WORDS = {
        ...
        'gain', 'gains', 'rise', 'rises', 'jump', 'jumps', 'upgrade', 'upgraded',
        'strong', 'strength', 'bullish', 'positive', 'growth', 'profit', 'profits',
        'revenue', 'earnings', 'outperform', 'outperforms', 'breakthrough', 'innovation',
        'success', 'successful', 'record', 'high', 'highs', 'buy', 'buying'
    }
    
    # Negative keywords
    NEGATIVE_WORDS = {
        'fall', 'falls', 'drop', 'drops', 'plunge', 'plunges', 'crash', 'crashes',
        'decline', 'declines', 'loss', 'losses', 'miss', 'misses', 'downgrade', 'downgraded',
        'weak', 'weakness', 'bearish', 'negative', 'concern', 'concerns', 'risk', 'risks',
        'lawsuit', 'investigation', 'fraud', 'scandal', 'bankruptcy', 'debt', 'cut', 'cuts',
        'layoff', 'layoffs', 'sell', 'selling', 'underperform', 'underperforms'
    }
