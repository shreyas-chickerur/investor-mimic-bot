...
from services.monitoring.slack_notifier import SlackConfig, SlackNotifier
...
class NotificationManager:
    ...
    async def send_alert(self, alert: Alert, channel: Optional[NotificationChannel] = None) -> bool:
        """
...
async def send_notification(alert: Alert, channel: Optional[NotificationChannel] = None) -> bool:
    """
