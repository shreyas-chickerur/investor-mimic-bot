...
class AdvancedTechnicalSignalGenerator:
    ...
    def generate_signal(
        ...
        composite_signal = (
            ma_data['ma_signal'] * 0.35 +          # Moving averages (trend)
            volume_data['volume_signal'] * 0.25 +   # Volume confirmation
            rs_data['rs_signal'] * 0.25 +           # Relative strength
            trend_data['trend_quality_signal'] * 0.15  # Trend quality
        )
