...
class TradeValidator:
    ...
    @staticmethod
    def validate_trade(ticker: str, action: str, quantity: float, price: float) -> Dict[str, Any]:
...
class FactorScoreValidator:
    ...
    @staticmethod
    def validate_composite_score(scores: Dict[str, float], weights: Dict[str, float]) -> float:
