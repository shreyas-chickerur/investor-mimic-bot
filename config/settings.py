...
class Settings(BaseSettings):
    ...
    DATABASE_URL: PostgresDsn = Field(
        "postgresql+asyncpg://postgres:postgres@localhost:5432/investorbot",
        env="DATABASE_URL"
    )
...
def get_notification_config():
    ...
    """
    from services.monitoring.notification_manager import NotificationConfig, NotificationChannel
